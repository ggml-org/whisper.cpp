# ggml vcpkg overlay port — Supertonic-fused tts-cpp build flavor
#
# Sources from `qvac-ext-ggml@speech` (which already carries every QVAC
# infrastructure patch + the Supertonic 2 fused custom ops as commits;
# see qvac-ext-ggml#8).  No local patches needed — the overlay-port is
# now just the build-options wrapper around the speech-branch source.
#
# Installed artefacts:
